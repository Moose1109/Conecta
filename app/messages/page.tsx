  ...
  return (
    <AuthenticatedShell>
      <AuthGate message="Para ver tus mensajes necesitas iniciar sesión.">
        <PageHeader eyebrow="Conversaciones" title="Mensajes" description="Un espacio cercano para conversar con vecinos y organizadores." />
        <BackendPendingAlert className="mb-5" actionHref="/community" actionLabel="Ir a comunidad" description="La experiencia de mensajería está diseñada, pero todavía no existe un endpoint real para listar conversaciones o enviar mensajes." />
